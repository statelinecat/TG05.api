...
async def start(message: Message):
   await message.answer("Привет! Напиши мне название породы кошки, и я пришлю тебе ее фото и информацию о ней.")

@dp.message(Command('help'))
async def help(message: Message):
   await message.answer("Напиши мне название породы кошки, и я пришлю тебе ее фото и информацию о ней.")
...
async def send_cat_info(message: Message):
   ...
   if breed_info is None:
      await message.answer("Такой породы кошки нет. Попробуй еще раз.")
   else:
